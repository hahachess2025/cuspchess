...
class ChessEngine:
    ...
    def run(self):
        try:
            ...
            elif  "NNCacheSize"   in options:
                self.engine.configure({
                        "Backend": "cudnn",      # or "cuda"
                        "Threads": 1,
                        "NNCacheSize": 512,      # MB, 
                        "MinibatchSize": 32,
                    })
    ...
    def go(self, board, limit,):
        ...
        if self.app.engine_time_limit_enable:
            ...
            search_limit = chess.engine.Limit(depth=limit)
        ...
        while not self._stop_flag.is_set():
            ...
            except (chess.engine.EngineTerminatedError, BrokenPipeError, OSError) as e:
    ...
    def query_multipv_support(self, engine: chess.engine.SimpleEngine) -> Tuple[bool, int, Optional[int]]:
        """
