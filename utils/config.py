...
def save_setting_in_config_file(cusp_app,config_path="config.ini"):
    ...
    config_object["saved_user_setting"] = {
        ...
        "Syzygy_tablebases_path": cusp_app.Syzygy_tablebases_path,
...
def read_config_file(cusp_app):
    ...
    try:
        ...
        if "Syzygy_tablebases_path" in user_setting.keys():
            cusp_app.Syzygy_tablebases_path = user_setting["Syzygy_tablebases_path"]
        if "endgame_tablebase_enable" in user_setting.keys():
            cusp_app.endgame_tablebase_enable = user_setting["endgame_tablebase_enable"] 
        ...
        # if both players can set up fight starting positions, we can check how many time for each player.
